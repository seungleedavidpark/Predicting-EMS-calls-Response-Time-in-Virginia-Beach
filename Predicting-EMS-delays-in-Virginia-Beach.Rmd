...
```{r, loading map files, message=FALSE, warning=FALSE, results='hide'}
...
### 3.4 Temporal features & Response Time
...
# 4. Model Building
After exploring and testing correlations of all the variables, we have started our model building process by inclduing all the features we have collected. 
